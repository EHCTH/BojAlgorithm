...
public class Main {
    ...
    static int transformIntegerAtString(Stack<String> answer) {
    ...
    static void permutation(int n, Stack<String> answer) {
        if (n > 0) {
            int a = transformIntegerAtString(answer);
            if (n > length || a > N) return;
